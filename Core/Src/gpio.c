...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, LED1_Pin|LED2_Pin|OUT2_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, OLED_CS_Pin|OLED_RES_Pin|OLED_DC_Pin|OUT1_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = LED1_Pin|LED2_Pin|OUT2_Pin;
