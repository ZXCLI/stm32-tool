...
//ssd1306
    ...
    OLED_WriteAdd(0x02); //[1:0],00，列地址模式;01，行地址模式;10,页地址模式;默认10;

    OLED_WriteAdd(0xA0); // 段重定义设置,bit0:0,0->0;1,0->127;
    OLED_WriteAdd(0xC0); // 设置COM扫描方向;bit3:0,普通模式;1,重定义模式 COM[N-1]->COM0;N:驱动路数
